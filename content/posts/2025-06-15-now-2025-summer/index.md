...
{{ fig(src="kenrokuen.jpg", alt="A torii gate in the Kenroku-en garden") }}
...
{{ fig(src="samurai_garden.jpeg", alt="The garden of a preserved samurai family home, with a koi fish pond and stone lantern") }}
...
{{ fig(src="wagyu_grill.jpeg", alt="Wagyu beef, mushroom and peppers on a tabletop charcoal grill") }}
