...
{{ fig(src="aliexpress_minipc_results.png", alt='Some of the results of a "mini pc" search query') }}
...
{{ fig(src="aliexpress_minipc.png", alt="A promotional image of the mini PC I picked, hosted here in case the product page goes poof. Please enjoy the broken English.") }}
