...
{{ fig(src="pursotin_fastfetch.png", alt="Fastfetch output showing the machine specs. Disregard the uptime (I took the screenshot way later)") }}
...
{{ fig(src="pursotin_raidz.svg", alt='A "RAID 1+0" configuration') }}
